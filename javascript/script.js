$(document).ready(function () {
  ...
  function typeAndErase() {
    if (!erasing) {
      holder.textContent = keywords[wordIndex].slice(0, charIndex + 1);
      charIndex++;

      if (charIndex === keywords[wordIndex].length) {
        setTimeout(() => {
          erasing = true;
    ...
    const speed = erasing ? 50 : 100; // Typing speed vs erasing speed
